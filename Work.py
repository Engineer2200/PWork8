...
change = 'Enter command: 1 - печать нашего словаря 2 - создание пустого фала, либо его обнуление 3 - запись в файл нашего словаря 4 - файл = списку 5 - поиск контакта 6 - добавление нового контакта 7 - Изменение данных контакта | w - Quit\n'
